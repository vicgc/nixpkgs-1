...
in {
  ...
  logstash = glPlugin rec {
    name = "graylog-lumberjack-${version}";
    pluginName = "graylog2-input-lumberjack";
    version = "1.0.0";
    src = fetchurl {
      url = "https://github.com/sivasamyk/${pluginName}/releases/download/v${version}/${pluginName}-${version}-rc1.jar";
