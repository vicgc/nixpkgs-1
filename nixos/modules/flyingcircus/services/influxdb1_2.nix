# This whole file can be removed once we upgrade to NixOS 17.03
{ config, lib, pkgs, ... }:

with lib;

let
  cfg = config.services.influxdb1_2;
...
in
{
  ...
  options = {
    ...
    services.influxdb1_2 = {
      ...
      package = mkOption {
        default = pkgs.influxdb1_2;
        defaultText = "pkgs.influxdb1_2";
  ...
  config = mkIf config.services.influxdb1_2.enable {

    systemd.services.influxdb = {
      description = "InfluxDB 1.2 Server";
